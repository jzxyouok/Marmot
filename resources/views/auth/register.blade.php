        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/passport/register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('validate_code') ? ' has-error' : '' }}">
                            <label for="password-confirm" class="col-md-4 control-label">验证码</label>

                            <div class="col-md-6">
                                <input id="password-confirm" type="text" class="form-control" name="validate_code">
